...
export default function WelcomePage() {
  ...
  return (
    <div className="min-h-screen w-full flex overflow-hidden relative">
      ...
      {/* RIGHT SLAB */}
      <div
        className="relative flex w-full lg:w-1/2 items-center justify-center px-6 sm:px-12"
        style={{
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-md p-12 rounded-2xl bg-gradient-to-br from-[#5D1616]/95 via-[#7B1F1F]/95 to-[#5D1616]/95 shadow-[0_30px_60px_rgba(0,0,0,0.5)] border border-[#C8A951]/30 overflow-hidden animate-fade-in-up">
          ...
          <svg className="absolute top-4 left-4 w-8 h-8 text-[#C8A951]/40" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 2L2 7v10c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-10-5z"/>
          </svg>
          <svg className="absolute top-4 right-4 w-8 h-8 text-[#C8A951]/40" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 2L2 7v10c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-10-5z"/>
          </svg>
          
          {/* Crown icon */}
          <div className="flex justify-center mb-6 animate-float">
            <svg className="w-16 h-16 text-[#C8A951]" viewBox="0 0 24 24" fill="currentColor">
              <path d="M5 16L3 5l5.5 5L12 4l3.5 6L21 5l-2 11H5m14 3c0 .6-.4 1-1 1H6c-.6 0-1-.4-1-1v-1h14v1z"/>
            </svg>
          </div>

          {/* WELCOME Heading */}
          <h1 className="text-center text-5xl md:text-6xl font-serif text-[#FFF8E1] mb-2 tracking-wide animate-text-glow" style={{ fontFamily: "'Playfair Display', serif" }}>
            WELCOME
          </h1>
          ...
          {/* Subtext */}
          <p className="text-center text-[#E8DCC8] mb-8 text-lg leading-relaxed" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
          ...
          <button
            ...
            className="group relative w-full rounded-xl bg-gradient-to-r from-[#C8A951] via-[#D4B76E] to-[#C8A951] text-[#2D0A0F] font-bold py-4 text-lg overflow-hidden shadow-[0_10px_30px_rgba(200,169,81,0.3)] transition-all duration-500 hover:shadow-[0_15px_40px_rgba(200,169,81,0.5)] hover:scale-[1.02]"
          ...
          <div className="mt-8 flex justify-center">
            <svg className="w-24 h-3 text-[#C8A951]/30" viewBox="0 0 100 10" fill="currentColor">
...
function RoyalLoader() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#FBF6EE]">
      ...
      {/* Royal Loader Card */}
      <div className="relative z-10 w-[320px] rounded-2xl bg-gradient-to-br from-[#5D1616]/95 via-[#7B1F1F]/95 to-[#5D1616]/95 shadow-[0_30px_60px_rgba(0,0,0,0.4)] border border-[#C8A951]/30 p-10 animate-scale-in">
        
        {/* Crown loader icon */}
        <div className="flex justify-center mb-6">
          <div className="relative">
            <svg className="w-20 h-20 text-[#C8A951] animate-spin-slow" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <circle cx="12" cy="12" r="10" className="opacity-25"/>
              <path d="M12 2a10 10 0 0 1 10 10" className="opacity-75"/>
            </svg>
            <svg className="absolute inset-0 w-20 h-20 text-[#C8A951]" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Loading text */}
        <p className="text-center text-[#E8DCC8] font-medium text-lg mb-6 animate-fade-in-out" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
