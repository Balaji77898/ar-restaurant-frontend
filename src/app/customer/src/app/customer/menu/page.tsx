...
export default function MenuPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FBF6EE] via-[#F5EFE0] to-[#FBF6EE] pb-24 relative overflow-x-hidden">
      ...
      {/* FLOWING IMAGE CAROUSEL - FASTER */}
      <div className="overflow-hidden relative h-32 my-4 border-y-2 border-[#C8A951]/20">
      ...
      {totalQty > 0 && (
        <button 
          onClick={() => router.push("/customer/cart")} 
          className="fixed bottom-4 left-4 right-4 bg-gradient-to-r from-[#7B1F1F] via-[#5D1616] to-[#7B1F1F] text-[#C8A951] px-6 py-4 font-bold text-lg shadow-[0_10px_40px_rgba(0,0,0,0.4)] z-40 rounded-xl border-2 border-[#C8A951]/50 hover:scale-[1.02] transition-all duration-300 animate-slide-up"
          style={{ fontFamily: "'Poppins', sans-serif" }}
        >
