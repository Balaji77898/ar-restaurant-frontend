...
export default function Profile() {
  ...
  const navItems = isCashier
    ? [
      { name: 'wallet', label: 'Billing', route: '/billing-payment', active: false },
      { name: 'person', label: 'Profile', route: '/profile', active: true },
    ]
    : [
      { name: 'home-outline', label: 'Home', route: '/staff-dashboard', active: false },
      { name: 'receipt-outline', label: 'Orders', route: '/orders', active: false },
      { name: 'person', label: 'Profile', route: '/profile', active: true },
    ];
